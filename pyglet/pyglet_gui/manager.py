...
from pyglet.pyglet_gui.constants import ANCHOR_CENTER, GetRelativePoint
from pyglet.pyglet_gui.core import Rectangle
from pyglet.pyglet_gui.containers import Wrapper
